...
\begin{figure}
    ...
    \caption[Bandgap versus lattice constant]{\label{fig:intro_bandgaps}Bandgap versus lattice constant for the most common semiconductors (modified from \cite{lattice-constant-diagram}) (used with permission)}
\end{figure}
