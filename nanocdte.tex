...
As the research group had been successful at producing thin films of CdTe, experiments were attempted in the production of CdTe nanowires using several metal catalysts.
...
The Bi\textsubscript{2}Te\textsubscript{3} seeds were prepared using the PLD process (GSI Lumonics IPEX-848 excimer laser, \textlambda~= 248 nm, laser energy density = 2 J~cm\textsuperscript{-2}, laser spot size = 1.2\(\times\)1.2 mm\textsuperscript{2}).
...
Prior to the deposition, the sapphire substrate was heated to 400\celsius{} and held there for 10 min in an oxygen background pressure of 300~mTorr.The substrate was then cooled to room temperature where a 20~\AA{} thick film of Bi\textsubscript{2}Te\textsubscript{3} was deposited.
...
Material from a rotating CdTe target, grown using the Bridgman method, was then ablated onto the substrate for time intervals typically in the range of 30?45 min at a laser repetition rate of 8~Hz.
...
\begin{figure}
 ...
 \begin{subfigure}[t]{0.5\textwidth}
  \centering \includegraphics[width=0.97\textwidth]{nanocdte_bite}
 ...
 \end{subfigure}%
 \begin{subfigure}[t]{0.5\textwidth}
  \centering \includegraphics[width=0.97\textwidth]{nanocdte_nanowires}
...
\begin{figure}
 \centering \includegraphics[width=0.7\textwidth]{nanocdte_polefigure}
...
\end{figure}
\begin{figure}
 \centering \includegraphics[width=0.7\textwidth]{nanocdte_lateral}
...
\begin{figure}
 ...
 \caption[CdTe nanowires with slanted tops]{\label{fig:nanocdte_slanted}SEM images of CdTe nanowires with slanted tops that have formed at the (a) left and (b) right edge of the substrate.
  Note that the tilt is in opposite directions.
...
\end{figure}
\begin{figure}
 \centering \includegraphics[width=0.7\textwidth]{nanocdte_tapered}
...
It is important to emphasize that well over one hundred samples have been characterized for each of the two nanowire deposition methods.
...
This is made evident by the fact that the CdTe nanowires grow in the absence of a two-dimensional planar layer.
...
\begin{figure}
 ...
 \caption[Simulated CdTe nanowire dimension distributions]{\label{fig:nanocdte_model}Simulation results showing (a) the time evolution of the nanowire height for the five labelled diameters and (b) time snapshots of the height versus diameter dependence for the times labelled.
  ...
  The values used in this simulation have been scaled so as to fit this experimental distribution.}
\end{figure}
...
However, around the periphery of each seed it is expected that the substrate's alcohol surface alteration persists.
...
In general, poor adhesion of adatoms to the substrate should be quite detrimental to a lateral growth mode as adatoms must already have a low probability of attaching to the sidewall facet; if this were not the case a one-dimensional nanowire growth mode would be unattainable.
...
This surface energy modification is a possible route to reducing or eliminating the parasitic thin film present during the growth of many semiconductor nanowires.
