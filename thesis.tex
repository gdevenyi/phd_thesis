...
{\Large
McMaster University DOCTOR OF PHILOSOPHY (2013) Hamilton, Ontario(Engineering Physics)\\ 
TITLE: The Role of Energy and Symmetry at Epitaxial Interfaces AUTHOR: Gabriel A. Devenyi, B.Eng. (McMaster University) SUPERVISOR: Professor John S. Preston NUMBER OF 
PAGES: ix, \pageref{LastPage}}
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	\begin{abstract}
		\thispagestyle{plain}
		\setcounter{page}{3}
