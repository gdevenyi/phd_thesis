...
%Even the most perfectly matched systems in terms of atomic bonding and lattice match can grow with defects if the deposition rate is too fast.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{back_growth_mode}
