...
\todo{Add more info from goldstien}Imaging of samples using backscattered electrons to achieve chemical composition requires optimization of the elastic scattering process from the sample.
...
\todo{ Reimer,L and Kohl, H (2008). Transmission Electron Microscopy: Physics of Image Formation. Springer}Beyond sample preparation, imaging in a TEM can be modified by tuning several parameters.
