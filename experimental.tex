...
\begin{figure}
 \centering \includegraphics[width=0.6\textwidth]{exp_xray_ewald}
...
\begin{figure}
 \centering \includegraphics[width=0.8\textwidth]{exp_xray_machine}
...
\begin{figure}
 \centering \includegraphics{exp_xrd_beam_width}
...
The last optimization parameter for 2DXRD scans is the amount of time spent collecting each frame.
...
\begin{figure}
 \centering \includegraphics{exp_xray_frame}
...
\begin{figure}
 \centering \includegraphics[width=\textwidth]{exp_xray_polefigure}
...
\subsubsection{Interpretation and Simulation of Pole Figures} Once a pole figure has been generated the resulting graphical representation of the diffraction data must be interpreted in the context of the sample.
...
\begin{figure}
 ...
 \begin{subfigure}[t]{0.55\textwidth}
  \centering \includegraphics[width=\textwidth]{exp_xrd_winwulff_si_100}
  \caption{\label{fig:exp_xrd_winwulff_si_100}WinWulff (111) pole figure of (100)-up silicon}
 \end{subfigure}%
 \begin{subfigure}[t]{0.45\textwidth}
  \centering \includegraphics[width=\textwidth]{exp_xrd_si_100}
...
\begin{figure}
 \centering \includegraphics{exp_xray_polefigure_examples}
...
\begin{figure}
 \centering \includegraphics[width=0.5\textwidth]{exp_em_electron_interaction}
...
Interpretation of the secondary electron images in one key case is ambiguous; topographic features with vertical extent can be appear due to the human visual system to be both a depression and a bump alternately.
...
Imaging of using backscattered electrons to achieve chemical composition requires optimization of the elastic scattering process from the sample.
Backscattered electron yield increases with increasing accelerating voltage but that also increases the area of interaction reducing resolution.
The elastic scattering process is significantly less efficient than secondary electron generation, as such dwell times must be increased to yield an image.
In order to obtain a true measure of chemical composition, samples for backscatter analysis should be as flat as possible, as topography can modify the yield of backscattered electrons.
Such processing as polishing can improve the chemical contrast.
...
When a sample have crystal defects which present the same zone axis, such as twins, they do not show up in diffraction contrast or traditional phase contrast.
...
\begin{figure}
 \centering \includegraphics[width=0.9\textwidth]{exp_PLD_chamber}
...
Regardless of the target material, a plume is generated at the laser spot which, due to it's timescales, is stochiometric with regards to the composition of the target.
