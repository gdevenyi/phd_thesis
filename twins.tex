...
\fullcite{Devenyi2011} \cite{Devenyi2011}.\\
This work was completed in close collaboration with Ms.~Steffi Woo, now a Ph.D. candidate in Material Science and Engineering at McMaster, with the TEM/STEM work performed exclusively by her, the 2DXRD work performed by me and all other work being collaborative.
\section{Background}
...
\begin{figure}
 \centering \includegraphics[width=\textwidth]{twins_polefigure}
...
\end{figure}
\begin{figure}
 \centering \includegraphics[width=\textwidth]{twins_tem2}
...
By breaking the symmtery on the (100) silicon surface through the use of vicinal substrates, an important change occurs on the energy landscape for a growing crystal, improving the overall quality of the film.
