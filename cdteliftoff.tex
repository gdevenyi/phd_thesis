...
Structural information was obtained using 2DXRD techniques.
...
\end{figure}
This weak bonding phenomenon had been previously hinted at when CdTe nanowires were observed in SEM to have toppled in place, as shown in \cref{fig:cdteliftoff_nanowires}, a event that could not have happened unless the bond strength with the interface was very weak.
...
Concurrent to investigations into the production of freestanding thin films via the liftoff process, the obvious question arose as to the properties of these films when compared to those attached to the epitaxial substrate.
...
A number of theoretical models have been examined by this group to explain the exceptional interface which yields epitaxial single crystal thin film growth and then releases the resulting film with relatively little effort.
...
Either of these mechanisms could have a significant impact on the interface between the CdTe and the sapphire.
...
Finally, it is possible that the bonding energies between the initial thin film nucleation layer and substrate to be very small, with bonding being more akin to Van der Waals forces than to the typical covalent or semi-ionic bonding seen in solids.
